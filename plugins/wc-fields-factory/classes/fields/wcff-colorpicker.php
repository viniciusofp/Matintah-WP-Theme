...
class wcff_field_colorpicker extends wcff_field {
	...
	function render_product_field( $field ) { 
		...
		<?php if( has_action('wccpf/before/field/rendering' ) && has_action('wccpf/after/field/rendering' ) ) : ?>
			...
			<input type="text" name="<?php echo esc_attr( $field["name"] . $name_index ); ?>" class="wccpf-field wccpf-color wccpf-color-<?php echo esc_attr( $field["name"] ); ?>" value="<?php echo $field["hex_color_show_in"] == "yes" ?  "&lt;span style&equals;&quot;padding: 0px 15px;background: $defaultcolor&quot; &gt; &lt;/span&gt" : $defaultcolor; ?>" wccpf-type="text" wccpf-pattern="mandatory" wccpf-mandatory="<?php echo $field["required"]; ?>" <?php echo $readonly; ?> />
			...
			<tbody>
				<tr>
					...
					<td class="wccpf_value">
						<input type="text" name="<?php echo esc_attr( $field["name"] . $name_index ); ?>" class="wccpf-field wccpf-color wccpf-color-<?php echo esc_attr( $field["name"] ); ?>" value="<?php echo $field["hex_color_show_in"] == "yes" ?  "&lt;span style&equals;&quot;padding: 0px 15px;background: $defaultcolor&quot; &gt; &lt;/span&gt" : $defaultcolor; ?>" wccpf-type="text" wccpf-pattern="mandatory" hex_color_show_in_color="<?php echo $field["hex_color_show_in"]; ?>" wccpf-mandatory="<?php echo $field["required"]; ?>" <?php echo $readonly; ?> />
						<span class="wccpf-validation-message wccpf-is-valid-<?php echo $this->valid; ?>"><?php echo $field["message"]; ?></span>
					</td>
				</tr>
			</tbody>
