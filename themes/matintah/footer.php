	...
	<div class="row">
		...
		<div class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-0 ">
			<style type="text/css">
				...
				.st2{fill-rule:evenodd;clip-rule:evenodd;fill:#E20717;}
				.st3{fill-rule:evenodd;clip-rule:evenodd;fill:#11448E;}
				.st4{fill-rule:evenodd;clip-rule:evenodd;fill:#EF7E08;}
				.st5{fill-rule:evenodd;clip-rule:evenodd;fill:#3AAF74;}
				.st6{fill-rule:evenodd;clip-rule:evenodd;fill:#D62E16;}
				.st7{fill-rule:evenodd;clip-rule:evenodd;fill:#302D7E;}
			</style>
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 284.3 399.9" style="enable-background:new 0 0 284.3 399.9;" xml:space="preserve">
				<g id="Camada_1">
				</g>
				<g id="Camada_20">
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/vivus.min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/jquery.SmoothState.js"></script>
...
<script async type="text/javascript">
	...
	var waypoint = new Waypoint({
	  element: $('#footer-bar'),
	  handler: function(direction) {
	    $('#footer-bar svg path').addClass('visible');
	  },
	  offset: '90%'
	});
...
<script type="text/javascript">
	...
	var myVivus2 =  new Vivus('my-svg2');
